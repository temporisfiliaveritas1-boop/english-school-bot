...
SCHEDULE_MSG = """
👩‍💻 Everyday — новые темы для обсуждения, язык английский, название чатов: Let's discuss. Обратите внимание на уровень! Присоединяйтесь в любое время в течении дня к обсуждению, ставьте этот эмоджи 👀 и преподаватель отправит фидбек в личные сообщения.
...
🎙️ Chatting — чат для повседневного общения, то самое место в группе, где можно общаться на русском! 😆
"""
