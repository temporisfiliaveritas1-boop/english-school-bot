...
Games - не пропускайте новые активности и игры, каждую неделю!

Cinema club - выбираем, что будем смотреть и встречаемся раз в 2 недели для обсуждения. Не забудьте воспользоваться Vocab list с полезными словами и выражениями!

Book club - выбираем, что будем читать и, раз в две недели, встречаемся на обсуждение на выходных. Не забудьте воспользоваться Vocab list с полезными словами и выражениями!
